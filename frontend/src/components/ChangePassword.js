                                ...
                                <div className="row justify-content-center">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label for="current_password" className="col-form-label required">Current Password</label>
                                        ...
                                        <div className="form-group">
                                            <label for="new_current_password" className="col-form-label required">New Password</label>
                                        ...
                                        <div className="form-group">
                                            <label for="repeat_new_current_password" className="col-form-label required">Repeat Password</label>
