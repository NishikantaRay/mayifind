            ...
            <div className="auto-container">
              <div className="outer-box">
                ...
                <div className="menu-area">
                  <div className="mobile-nav-toggler" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="#navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
